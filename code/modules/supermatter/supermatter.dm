...
#define CRYOTHEUM_DAMPING_FACTOR 3 // Higher == O2B blocks less heat release. keep above 0. This is the number of effective moles that will result in half heat output.
